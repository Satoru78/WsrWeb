...
<body>
    <form id="form1" runat="server">
        <div class="center">
            ...
            <asp:GridView ID="GridViewData" runat="server" DataKeyNames="ID"  AutoGenerateDeleteButton="true"  OnRowDeleting="GridViewData_RowDeleting" AutoGenerateColumns="False" OnRowEditing="GridViewData_RowEditing" >
                <Columns>
